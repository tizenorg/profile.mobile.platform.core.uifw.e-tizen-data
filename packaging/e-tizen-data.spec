...
%__cp -afr %{_arch}/config/tizen-mobile/*.cfg %{buildroot}/usr/share/enlightenment/data/config/tizen-mobile
%__cp -afr data/backgrounds/*.edj         %{buildroot}/usr/share/enlightenment/data/backgrounds
